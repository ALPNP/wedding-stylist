	...
	<head>
		...
		<style type='text/css'>
			...
			.widget {
				...
				border:1px solid rgba(194, 229, 227, 0.3);
				background:rgba(249, 193, 194, 0.3);
			...
			.widget .profile td {
				border:2px solid rgba(194, 229, 227, 0.8);
			}
			...
			.widget a.follow:link, .widget a.follow:visited {
				...
				-webkit-border-radius: 5px 5px 5px 5px;
				-moz-border-radius: 5px 5px 5px 5px;
				box-shadow: 0 0px 2px rgba(194, 229, 227, 0.8);
				-moz-box-shadow: 0 0px 2px rgba(194, 229, 227, 0.8);
				-webkit-box-shadow: 0 0px 2px rgba(194, 229, 227, 0.8);
			}
			.widget a.follow:hover {
				background:rgba(249, 193, 194, 0.9);
			}
			.widget .data {
				text-align:left;
